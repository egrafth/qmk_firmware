...
[_RAISE_GER] = LAYOUT_planck_grid(
    KC_EXLM,  GER_AT,  GER_DLR, GER_LBRC, GER_LCBR,  GER_LPRN,  GER_RPRN,  GER_RCBR, GER_RBRC, GER_CIRC,  GER_AMPR, GER_PIPE,
    GER_UNDS, KC_1,    GER_2,   GER_3,    KC_4,      KC_5,      GER_6,     GER_7,    GER_8,    GER_9,     GER_0,    GER_BSLS,
    KC_NUHS,  GER_AE,  GER_OE,  GER_UE,   GER_SS,    KC_PERC,   GER_TILD,  GER_EQL,  GER_PLUS, GER_MINUS, GER_ASTR, KC_ENT,
 ...
 *                      v------------------------RGB CONTROL--------------------v
 * ,-----------------------------------------------------------------------------------.
 * |RGB Tog|RGBMod|      |Reset |      |Qwerty|Qwerty|Mouse1| MWhD | MWhU |Mouse2|Sleep |
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * | HUE+  | HUE- |      |Debug |      |Colemk|Dvorak|MouseL|MouseD|MouseU|MouseR|      |
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * | SAT+  | SAT- |      |      |      |Plover|      |      |      | Vol+ | Vol- | Mute |
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * | INT+  | INT- |      |      |      |             |      |      | Prev | Play | Next |
 * `------------------------------------------------------------------------------------'
 */
[_ADJUST_GER] = LAYOUT_planck_grid(
    RGB_TOG, RGB_MOD, XXXXXXX, RESET,   XXXXXXX, QWERTY_GER, QWERTY_US, KC_BTN1, KC_WH_D, KC_WH_U, KC_BTN2, KC_SLEP,
    RGB_HUI, RGB_HUD, XXXXXXX, DEBUG,   XXXXXXX, COLEMAK,    DVORAK,    KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX,
...
layer_state_t default_layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(0, layer_state_cmp(state, _QWERTY_GER));
    return state;
};
